...
FRONTEND_DIR = os.path.join(ROOT_DIR, "Frontend Code")
...
2. Match {user_name}'s language seamlessly! If they write in Hindi or Hinglish, respond in natural, expressive Hinglish/Hindi. If they write in English, respond in English.
